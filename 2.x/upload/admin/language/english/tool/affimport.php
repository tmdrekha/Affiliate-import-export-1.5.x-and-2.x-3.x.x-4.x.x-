<?php
// Heading
$_['heading_title']    = 'Import Affiliate Excel file <b>TMD</b>  ';
$_['button_import']    = 'Import file  ';
$_['entry_import']    = 'Import xls File <br/> Please Import Same format if you have not format please download <a href="'.HTTP_CATALOG.'image/data/template/affiliate_export.xls" data-toggle="tooltip" title="Download format">From here</a>';
